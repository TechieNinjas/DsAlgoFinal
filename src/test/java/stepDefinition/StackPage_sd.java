...
public class StackPage_sd extends BaseClass {
	...
	public void user_tests_the_stack_datastructure_with_simple_python_code_print_hello_and_gives_the_hello(String input, String output) throws InterruptedException {
	...
	public void user_tests_the_stack_datastructure_with_wrong_hello_and_gives_the_error(String wronginput, String errortext) throws InterruptedException {
		new StackPage_pom().StackGetStrtdBtn();
		new  StackPage_pom().OperationsinStackBtn();
